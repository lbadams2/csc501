...
CFLAGS  = -m32 -fno-builtin -c -Wall -O ${DEFS} ${INCLUDE}
SDEFS	= -I../h
ASFLAGS = --32
...
XOBJ = startup.o initialize.o intr.o clkint.o ctxsw.o zfunction.o
...
zfunction.o: ../sys/zfunction.S
        ${CPP} ${SDEFS} ../sys/zfunction.S | ${AS} ${ASFLAGS} -o zfunction.o
...
y.tab.o: ../config/y.tab.c /usr/include/stdc-predef.h \
 ...
 /usr/include/bits/stdlib-float.h ../h/stdio.h ../config/lex.yy.c \
